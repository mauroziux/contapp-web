                    ...
                    <div class="col-md-8 col-md-offset-2 col-sm-12">
                      <div class="tabbed-carousel__nav" data-toggle="tabs">
                        ...
                        <a class="tabbed-carousel__nav-item" href="#informes">
                          <i class="fa fa-cog fa-2x icon"></i> Informes
                        </a>
                        <a class="tabbed-carousel__nav-item" href="#crecer">
                          <i class="fa fa-cog fa-2x icon"></i> Crecer
                        </a>
                      </div>
                    </div>
                  </section>
                    ...
                    <div class="row">
                      <div class="block-content tab-content remove-padding">
                        <div class="tab-pane active" id="vender">
                          <div class="col-sm-6">
                            <div class="push-100-l push-50-t">
                              <h3 class="h1 font-s36 text-center text-white push">El sistema POS listo para vender</h2>
                                <div class="padding-30">
                                  <blockquote>
                                    <p>Crea y agrega productos o servicios rapidamente, cambia sus cantidades o precios en cualquier momento,
                                      escoge el medio de pago que desees y listo, imprime o envia la factura por correo electrónico.</p>
                                  </blockquote>
                                </div>
                            </div>
                          </div>
