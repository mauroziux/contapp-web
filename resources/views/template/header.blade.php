<header id="header-navbar" class="content-mini content-mini-full">
    <div class="content-boxed ">
        ...
        <ul class="js-nav-main-header nav-main-header push-5-t pull-right">
            ...
            <li>
                <a class="h4 text-center text-white font-w400" href="#">Características</a>
            </li>
            <li>
                <a class="h4 text-center text-white font-w400" href="#">Planes</a>
            </li>
            <li>
                <a class="h4 text-center text-white font-w400" href="#">Login</a>
            </li>
